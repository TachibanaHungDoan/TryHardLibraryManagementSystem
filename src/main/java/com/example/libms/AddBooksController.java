...
public class AddBooksController {
    ...
    private AlertShowing alertShow = new AlertShowing();
    ...
    public void addBook() {
        ...
        if (title.isEmpty() || author.isEmpty() || publisher.isEmpty() || publishedDateStr.isEmpty() || isbn.isEmpty() || editionStr.isEmpty() ||
            ...
            alertShow.showAlert(null, null, "All fields must be filled.", Alert.AlertType.WARNING);
        }
        ...
        try {
            ...
            alertShow.showAlert(null, "Invalid date format.", "Please enter Published Date with the format of Year-Month-Day", Alert.AlertType.ERROR);
            return;
        }
        ...
        try {
            ...
            alertShow.showAlert(null, null, "Edition, Quantity, and Remaining must be valid integers.", Alert.AlertType.ERROR);
            return;
        } // Check if remaining is greater than or equal to quantity
        if (remaining > quantity) {
            soundButtonController.alertSoundPlay();
            alertShow.showAlert(null, null, "Remaining cannot be greater than Quantity.", Alert.AlertType.WARNING);
            return;
        ...
        try {
            ...
            alertShow.showAlert(null, null, "Book added successfully!", Alert.AlertType.INFORMATION);
        } catch (Exception ex) {
            soundButtonController.alertSoundPlay();
            alertShow.showAlert(null, null, "Failed to add book.", Alert.AlertType.ERROR);
        }
    }
